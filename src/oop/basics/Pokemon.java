...
public class Pokemon {
    ...
    Pokemon(String name, String type, int healthPoint, int attackPoint) {
        ...
        this.name = name; // this. is mandatory for name since param name == instance var name
        this.type = type;
    ...
    boolean dodge() {
        // randomly you have 50% chance of dodging (randomly)
        // returns a random double value from 0.0 to 1.0
